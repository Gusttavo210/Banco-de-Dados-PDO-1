...
<html lang="pt-br">
    <head>
        ...
        <title>Agency - Lista de Cadastro</title>
        <!-- Favicon-->
                ...
                <table class="table table-stripped" style="color: white;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $post->id ?></td>
                            <td><?= $post->postitle ?></td>
                            <td><?= $post->postsubtitle ?></td>
                            <td><?= $post->data ?></td>
                            <td>
                                <a href="post.form.edit.php?id=<?= $post->id ?>"><i class="fa-solid fa-pencil"></i></a>&nbsp;
                                <a onclick="return confirm('Deseja realmente remover este item?')" href="php/post.delete.php?id=<?= $post->id ?>"><i class="fa-solid fa-trash-can"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
