        ...
        <section class="page-section" id="servicos">
            <div class="container">
                ...
                <table class="table table-stripped" style="color: white;">
                    ...
                    <tbody>
                        <?php foreach (listaSobre() as $about) : ?>
                        <tr>
                            <td><?= $about->descricao ?></td>
                            <td>
                                <a href="about.form.edit.php?id=<?= $about->id ?>"><i class="fa-solid fa-pencil"></i></a>&nbsp;
                                <a onclick="return confirm('Deseja realmente remover este item?')" href="php/about.delete.php?id=<?= $about->id ?>"><i class="fa-solid fa-trash-can"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
